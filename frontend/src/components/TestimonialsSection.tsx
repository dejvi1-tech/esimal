...
const testimonials = [
  ...
  },
  {
    name: 'Elena P.',
    review: {
      al: 'Mbështetje e shkëlqyer dhe aktivizim i shpejtë. Do ta përdor përsëri për udhëtimin tim të radhës.',
      en: 'Great support and fast activation. Will use again for my next trip.'
    },
    rating: 4,
    country: {
      al: 'Itali',
